...
/**
 * @file
 * Contains \Kanooh\Paddle\Pages\Admin\Apps\PaddleTimeStamp\ConfigurePage\ConfigureForm.
 */
...
/**
 * Class representing the Paddle Timestamp configuration form.
 *
...
class ConfigureForm extends Form
{
    ...
    {
        $base_id = 'edit-paddle-timestamp-content-types-';
        switch ($name) {
