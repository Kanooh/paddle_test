...
/**
 * @file
 * Contains Kanooh\Paddle\Pages\Node\EditPage\AdvancedSearch\VocabularyTermsTableRow.
 */
...
/**
 * Class representing a single row in the vocabulary terms table.
 *
 ...
 * @property VocabularyTermDisplayModeRadios $mode
 *   The radios to configure the display mode for the term in the frontend.
 */
class VocabularyTermsTableRow extends Row
{
    /**
    ...
    /**
     * Constructs an VocabularyTermsTableRow object.
     *
    ...
    public function __get($name)
    {
        switch ($name) {
            ...
            case 'mode':
                return new VocabularyTermDisplayModeRadios($this->webdriver, $this->element);
        }
