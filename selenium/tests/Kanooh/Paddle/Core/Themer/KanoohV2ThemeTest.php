...
/**
 * @file
 * Contains \Kanooh\Paddle\Core\Themer\KanoohV2ThemeTest.
 */
...
/**
 * Class KanoohV2ThemeTest
 * @package Kanooh\Paddle\Core\Themer
 * @runTestsInSeparateProcesses
 * @preserveGlobalState disabled
 */
class KanoohV2ThemeTest extends WebDriverTestCase
{
    /**
     * @var AppService
     */
    ...
    */
    public function testVoBranding()
    {
        ...
        // Verify you can create a new theme based on the kanooh_theme_v2.
    ...
    public function testMenuStyleSettings()
    {
        ...
        // Verify that you can select the fly out menu.
        $this->themerEditPage->header->menuStyleOptions->flyOutMenu->select();
        $this->themerEditPage->buttonSubmit->click();
        $this->themerOverviewPage->checkArrival();

        // Verify that the selection is kept.
        $this->themerEditPage->go($theme_name);
        $this->assertTrue($this->themerEditPage->header->menuStyleOptions->flyOutMenu->isSelected());
        $this->themerEditPage->buttonSubmit->click();
        $this->themerOverviewPage->checkArrival();
    }
    ...
    public function testFooterLinks()
    {
        ...
        $this->assertNotEmpty($this->themerEditPage->footer->footerStyleDescriptions);
