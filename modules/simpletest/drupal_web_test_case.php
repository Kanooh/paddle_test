...
class DrupalWebTestCase extends DrupalTestCase {
  ...
  protected function setUp() {
    ...
    // During the first static reset, some caches might have been already
    // re-initialized with values from the main installation.
    drupal_static_reset();
  ...
  protected function refreshVariables() {
    ...
    $conf = array();
    // We need to see if variables were set in settings.php.
    if (file_exists(DRUPAL_ROOT . '/' . conf_path() . '/settings.php')) {
      // Include settings.php. This generates errors because it reruns ini_set()
      // statements, so we suppress error messages.
