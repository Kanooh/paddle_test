...
(function() {
  var imageDialog = function(editor, dialogType) {
    ...
    var onImgLoadErrorEvent = function() {
      ...
      // Set Error image.
      var noimage = CKEDITOR.getUrl(CKEDITOR.plugins.get('paddle_scald_image').path + 'images/noimage.png');
          ...
          children: [{
            ...
            children: [{
              ...
              setup: function(type, element) {
                if (type == IMAGE) {
                  if (element.hasAttribute('class') && element.getAttribute('class').indexOf('atom-id-') !== -1) {
  ...
  CKEDITOR.dialog.add('paddle_scald_image', function(editor) {
