...
class panels_renderer_paddle_pane_collection extends panels_renderer_paddle {
  ...
  public function ajax_save_form($break = NULL) {
    ...
    if ($form_saved) {
      // Add a message.
      drupal_set_message(t('@what has been updated.', array('@what' => $this->display->context['panelizer']->data->title)), 'status');

      // Get back to the overview page.
      $this->commands[] = ctools_ajax_command_redirect('admin/paddlet_store/app/paddle_pane_collection/configure');
    }
  }
