...
class panels_renderer_paddle_mega_dropdown extends panels_renderer_paddle {
  ...
  public function ajax_save_form($break = NULL) {
    ...
    if ($form_saved) {
      ...
      $this->commands[] = ctools_ajax_command_redirect(_paddle_mega_dropdown_admin_overview_path());
    }
  }
