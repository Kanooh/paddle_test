...
/**
 * @file
 * Theme implementation to display a node in the 'spotlight_extended' view mode.
 *
 * Available variables:
...
<li class="col--3-12 col--4-12--m col--6-12--s col--1-1--xs">
  <a href="<?php print $node_url; ?>" class="spotlight">
    <article>
      <?php if (!empty($image)): ?>
