...
<div id="page" class="full-height content-background-canvas">
  <div>
    <a href="#page-content"
       class="visuallyhidden focusable"><?php print t('Skip to main content'); ?></a>
    <a name="top" id="top"></a>
  </div>
  ...
  <header>
    <div
      class="max-width header-background-canvas <?php print $header_search; ?>">
      <div class="mobile-menu">
        <a href="#" class="mobile-menu-trigger"
           aria-label="<?php print t('Navigation'); ?>">
          <i class="fa fa-align-left"></i> <span
            class="visuallyhidden"><?php print t('Navigation'); ?>></span>
        </a>
      </div>
      <?php if (variable_get('paddle_style_show_search_box', TRUE)): ?>
        <a href="#" class="mobile-search-btn">
          <i class="fa fa-search"></i> <span
            class="visuallyhidden"><?php print t('Search'); ?></span>
        </a>
      <?php endif; ?>
      <div class="paddingizer">
        <div class="row">
          <?php if (!empty($header_title) || (!empty($logo) && variable_get('paddle_core_header_show_logo',
                FALSE)) || !empty($header_title_prefix)): ?>
            <div class="col-md-6 logo-wrapper">
              <?php if (!empty($logo) && variable_get('paddle_core_header_show_logo',
                  FALSE)): ?>
                <a href="<?php print $front_page; ?>"
                   title="<?php print t('Home'); ?>" rel="home" id="logo">
                  <?php if (!empty($logo_alt)): ?>
                    <img src="<?php print $logo; ?>"
                         alt="<?php print $logo_alt ?>"/>
                  <?php else: ?>
                    <img src="<?php print $logo; ?>"/>
                  <?php endif; ?>
                </a>
          ...
          <?php else: ?>
            <?php if (!empty($page['service_links'])): ?>
              <div
                class="col-md-6 col-md-offset-6 region-service-links-wrapper">
                <?php print render($page['service_links']); ?>
              </div>
            <?php endif; ?>
          <?php endif; ?>
