...
<div class="<?php print $classes;?>">
  <?php if (!empty($result_count)) : ?>
    <?php if (isset($display_search_result_count) && $display_search_result_count) : ?>
      <div class="search-result-count">
        <?php print format_plural($result_count, '1 result', '@count results'); ?>
      </div>
    <?php endif; ?>
    ...
    <div class="pager-wrapper last"><?php print render($pager); ?></div>
  <?php else : ?>
