 ...
 */
function kanooh_theme_v2_paddle_themer_style_set() {
 ...
 */
function kanooh_theme_v2_paddle_themer_plugin_instances() {
  ...
  $non_panes_font_mapping = array(
    ...
    'paragraph_font' => '.field-name-body p, .panel-pane .pane-content .pane-section-body .node .field-name-body p, .paddle-oup-parent-units, .paddle-oup-address, .paddle-oup-phone, .paddle-oup-fax, .paddle-cp-manager, .paddle-cp-ou-levels, .paddle-cp-address-container, .paddle-cp-phone-office, .paddle-cp-mobile-office, .paddle-cp-fax, .paddle-cp-skype, .field-name-field-paddle-introduction p',
    'paragraph_landing_page_font' => '.region-content .landing-page-body p',
    'links_font' => '.field-name-body a, .panel-pane .pane-content .pane-section-body .node .field-name-body a, .paddle-oup-email a, .paddle-oup-website a, .paddle-cp-manager a, .paddle-cp-email a, .paddle-cp-website a, .paddle-cp-linkedin a, .paddle-cp-twitter a, .paddle-cp-yammer a, .field-name-field-paddle-introduction a',
    'links_mouse_hover_font' => '.field-name-body a:hover, .panel-pane .pane-content .pane-section-body .node .field-name-body a:hover, .paddle-oup-email a:hover, .paddle-oup-website a:hover, .paddle-cp-manager a:hover, .paddle-cp-email a:hover, .paddle-cp-website a:hover, .paddle-cp-linkedin a:hover, .paddle-cp-twitter a:hover, .paddle-cp-yammer a:hover, .field-name-field-paddle-introduction a:hover',
    'links_visited_font' => '.field-name-body a:visited, .panel-pane .pane-content .pane-section-body .node .field-name-body a:visited, .paddle-oup-email a:visited, .paddle-oup-website a:visited, .paddle-cp-manager a:visited, .paddle-cp-website a:visited, .paddle-cp-linkedin a:visited, .paddle-cp-twitter a:visited, .paddle-cp-yammer a:visited, .field-name-field-paddle-introduction a:visited',
    'lists_font' => '.field-name-body ul li, .field-name-body ol li, .panel-pane .pane-section-body .node .field-name-body ul li, .pane-section-body .node ol li, .field-name-field-paddle-introduction ul li',
    'lists_links_font' => '.field-name-body ul li a, .field-name-body ol li a, .panel-pane .pane-content .pane-section-body .node .field-name-body ul li a, .pane-section-body .node ul li a, .field-name-field-paddle-introduction ul li a',
    'lists_links_hover_font' => '.field-name-body ul li a:hover, .field-name-body ol li a:hover, .panel-pane .pane-content .pane-section-body .node .field-name-body ul li a:hover, .pane-section-body .node ul li a:hover, .field-name-field-paddle-introduction ul li a:hover',
    'lists_links_visited_font' => '.field-name-body ul li a:visited, .field-name-body ol li a:visited, .panel-pane .pane-content .pane-section-body .node .field-name-body ul li a:visited, .pane-section-body .node ul li a:visited, .field-name-field-paddle-introduction ul li a:visited',
  ...
  $panes_font_mapping = array(
    'top_text_pane_font' => '.panel-pane .pane-content .pane-section-top, .panel-pane .pane-content .pane-section-top h2, .agenda-search-pane-title.pane-section-top, .agenda-search-pane-title.pane-section-top h2',
    'top_text_pane_link_font' => '.panel-pane .pane-section-top a, .panel-pane .pane-section-top a h2',
    'top_text_pane_link_hover_font' => '.panel-pane .pane-section-top a:hover, .panel-pane .pane-section-top a h2:hover',
    ...
    'links_pane_font' => '.panel-pane .pane-content .pane-section-body a, .panel-pane .pane-content .pane-section-body .list-news-item a .info',
  ...
  $plugin_instances['color_palettes'] = array(
    ...
    'allowed_values' => kanooh_theme_v2_define_color_palettes(),
    'default_values' => array(
 ...
 */
function kanooh_theme_v2_define_color_palettes() {
  return array(
