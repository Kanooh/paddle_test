...
?>
<div class="paddle-layout-paddle_3_col_c">
  <div class="row <?php print $custom_styles['top']; ?>">
    <div class="col-xs-12 root-column panel-region-top">
      <?php print $content['top']; ?>
    </div>
  </div>
  <div class="row <?php print $custom_styles['1_a']; ?>">
  ...
  <div class="row <?php print $custom_styles['3_b']; ?>">
