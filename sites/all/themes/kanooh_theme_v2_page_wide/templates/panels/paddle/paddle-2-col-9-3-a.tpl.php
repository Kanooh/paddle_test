...
?>
<div class="row paddle-layout-paddle_2_col_9_3_a <?php print $custom_styles['nested_top']; ?>">
  <div class="col-md-9 root-column">
      <div class="row">
        <div class="col-md-12 panel-region-nested-top"><?php print $content['nested_top']; ?></div>
      </div>
      <div class="row">
          <div class="col-md-12 col-lg-6 panel-region-nested-left"><?php print $content['nested_left']; ?></div>
          <div class="col-md-12 col-lg-6 panel-region-nested-right"><?php print $content['nested_right']; ?></div>
      </div>
      <div class="row">
