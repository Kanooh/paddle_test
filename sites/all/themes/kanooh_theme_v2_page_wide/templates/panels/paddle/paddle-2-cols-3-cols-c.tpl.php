 ...
 *
 * First row has 3 columns in a 4-4-4 division based on 12-grid.
 * Second row has 2 columns in a 4-8 division based on 12-grid.
 *
 * Variables:
...
<div class ="row paddle-layout-paddle_2_cols_3_cols_c <?php print $custom_styles['row_1_left']; ?>">
  <div class="col-md-12">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="panel-panel panel-col panel-region-row-1-middle">
        <div>
          <?php print $content['row_1_middle']; ?>
        </div>
      </div>
    </div>
...
<div class="row paddle-layout-paddle_2_cols_3_cols_c <?php print $custom_styles['row_2_left']; ?>">
  <div class ="col-md-12">
    <div class="col-md-8">
