 ...
 *
 * First row has 2 columns in a 4-8 division based on 12-grid.
 ...
 * - $content['bottom_row']: The bottom row.
 */
?>
<div class ="row paddle-layout-paddle_2_cols_3_cols_d <?php print $custom_styles['row_1_left']; ?>">
  <div class ="col-md-12">
...
<div class="row paddle-layout-paddle_2_cols_3_cols_d <?php print $custom_styles['row_2_left']; ?>">
  <div class="col-md-12">
    <div class="col-md-6 col-lg-4">
...
<div class="row paddle-layout-paddle_2_cols_3_cols_d <?php print $custom_styles['bottom_row']; ?>">
  <div class="col-md-12 <?php print $custom_styles['bottom_row']; ?>">
