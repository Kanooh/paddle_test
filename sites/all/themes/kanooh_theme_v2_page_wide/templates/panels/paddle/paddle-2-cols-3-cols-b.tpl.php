...
<div class ="row paddle-layout-paddle_2_cols_3_cols_b <?php print $custom_styles['row_1_left']; ?>">
  <div class ="col-md-12">
...
<div class="row paddle-layout-paddle_2_cols_3_cols_b <?php print $custom_styles['row_2_left']; ?>">
  <div class="col-md-12">
    <div class="col-md-6 col-lg-4">
