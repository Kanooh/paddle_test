        ...
        <div class="max-width header-background-canvas">
            <div class="mobile-menu">
                <a href="#" class="mobile-menu-trigger" aria-label="<?php print t('Navigation'); ?>">
                    <i class="fa fa-align-left"></i> <span class="visuallyhidden"><?php print t('Navigation'); ?>
                        ></span>
                </a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="footer-branding">
                        <a href="http://www.g-o.be/" class="main-go-link"><img
                                    src="<?php print $base_path . $directory; ?>/images/footer_logo_xs.png"
                                    alt="Go!"></a>
                    </div>
                </div>
            </div>
