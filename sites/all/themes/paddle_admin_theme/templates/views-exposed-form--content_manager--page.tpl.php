...
/**
 * @file
 * Handles the layout of the views exposed filters on the content manager page.
 *
 * Specifically, it makes sure that the fieldset with extra filters is displayed
...
<?php if (!empty($q)): ?>
  ...
  ?>
<?php endif; ?>
<div class="views-exposed-form has-show-more-fieldset">
  <div class="views-exposed-widgets clearfix">
    <?php foreach ($widgets as $id => $widget): ?>
      <?php if ($id != "filter-secondary"): ?>
